...
/**
 * @file
 * Contains \Drupal\plusminuscode_custom\Plugin\field\formatter\QuizDefaultFormatter.
 */

namespace Drupal\plusminuscode_custom\Plugin\Field\FieldFormatter;
 ...
 * @FieldFormatter(
 *   id = "quiz_default",
 *   label = @Translation("Plusminuscode Quiz Formatter"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
